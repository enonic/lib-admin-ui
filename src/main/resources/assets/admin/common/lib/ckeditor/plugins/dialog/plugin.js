...
(function () {
    ...
    function buildDialog(editor) {
        ...
        if (CKEDITOR.env.ie && !CKEDITOR.env.quirks && !CKEDITOR.env.edge) {
            var src = 'javascript:void(function(){' +
                      encodeURIComponent('document.open();(' + CKEDITOR.tools.fixDomain + ')();document.close();') + '}())', // jshint ignore:line
        ...
        function keydownHandler(evt) {
            ...
            if (keystroke == 9 || keystroke == CKEDITOR.SHIFT + 9) {
                ...
                var prevKeyCodes = [
                    ...
                    nextId = CKEDITOR.tools.indexOf(prevKeyCodes, keystroke) != -1
    ...
    CKEDITOR.dialog.prototype = {
        ...
        resize: (function () {
            return function (width, height) {
                ...
                if (this._.editor.lang.dir == 'rtl' && this._.position) {
                    this._.position.x = CKEDITOR.document.getWindow().getViewPaneSize().width - this._.contentSize.width -
        ...
        hide: function () {
            ...
            if (!this._.parentDialog) {
                ...
                var parentElement = this._.parentDialog.getElement().getFirst();
                parentElement.setStyle('z-index', parseInt(parentElement.$.style.zIndex, 10) +
    ...
    function initResizeHandles(dialog) {
        ...
        var mouseDownFn = CKEDITOR.tools.addFunction(function ($event) {
            ...
            wrapperHeight = startSize.height -
                            dialog.parts.contents.getSize('height', !( CKEDITOR.env.gecko || CKEDITOR.env.ie && CKEDITOR.env.quirks ));
        ...
        CKEDITOR.ui.dialog = {
            ...
            uiElement: function (dialog, elementDefinition, htmlList, nodeNameArg, stylesArg, attributesArg, contentsArg) {
                ...
                dialog.on('load', function () {
                    ...
                    if (input) {
                        var focusClass = me.type in {'checkbox': 1, 'ratio': 1} && CKEDITOR.env.ie && CKEDITOR.env.version < 8
            ...
            hbox: function (dialog, childObjList, childHtmlList, htmlList, elementDefinition) {
                ...
                CKEDITOR.ui.dialog.uiElement.call(this, dialog, elementDefinition || {type: 'hbox'}, htmlList, 'table', styles, attribs,
                    innerHTML);
            },
    ...
    CKEDITOR.ui.dialog.hbox.prototype = CKEDITOR.tools.extend(new CKEDITOR.ui.dialog.uiElement(), {
        ...
        getChild: function (indices) {
            ...
            if (indices.length < 2) {
                ...
                return ( this._.children[indices[0]] && this._.children[indices[0]].getChild ) ? this._.children[indices[0]].getChild(
                    indices.slice(1, indices.length)) : null;
            }
        }
    }, true);
