...
(function () {
    ...
    Notification.prototype = {
         ...
         */
        _getClass: function () {
            return ( this.type == 'progress' ) ? 'cke_notification_info' : ( 'cke_notification_' + this.type );
        },
        ...
        _hideAfterTimeout: function () {
            ...
            if (typeof this.duration == 'number') {
                ...
                duration =
                    ( typeof this.editor.config.notification_duration == 'number' ) ? this.editor.config.notification_duration : 5000;
            }
    ...
    Area.prototype = {
        ...
        _layout: function () {
            ...
            var leftBase = area.getStyle('position') == 'fixed'
                ? contentsRect.left
                : body.getComputedStyle('position') != 'static'
                               ? contentsPos.x - bodyPos.x
                               : contentsPos.x;
