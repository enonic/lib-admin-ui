        ...
        _: {
            ...
            showSubMenu: function (index) {
                ...
                if (menu) {
                    ...
                    menu = this._.subMenu =
                        new CKEDITOR.menu(this.editor, CKEDITOR.tools.extend({}, this._.definition, {level: this._.level + 1}, true));
                    menu.parent = this;
                ...
                if (!panel) {
                    ...
                    this._.itemOverFn = CKEDITOR.tools.addFunction(function (index) {
                        ...
                        this._.showSubTimeout =
                            CKEDITOR.tools.setTimeout(this._.showSubMenu, editor.config.menu_subMenuDelay || 400, this, [index]);
                    }, this);
        ...
        proto: {
            render: function (menu, index, output) {
                ...
                var params = {
                    ...
                    index: index,
                    iconStyle: CKEDITOR.skin.getIconStyle(iconName, ( this.editor.lang.dir == 'rtl' ),
                        iconName == this.icon ? null : this.icon, this.iconOffset),
