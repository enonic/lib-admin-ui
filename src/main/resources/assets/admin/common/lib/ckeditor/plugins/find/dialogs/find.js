...
(function () {
    ...
    function q(c, g) {
        ...
        n.prototype = {
            next: function () {
                ...
                if (b && a && 0 < this.offset) {
                    ...
                    for (b = null; !b && !(b = this._.walker[a ? "previous" : "next"].call(this._.walker), this._.matchWord && !b ||
                                                                                                           this._.walker._.end);) {
                        ;
                    }
            ...
            feedCharacter: function (a) {
                for (this._.ignoreCase && (a = a.toLowerCase()); ;) {
                    if (a == this._.pattern.charAt(this._.state)) {
                        return this._.state++, this._.state == this._.pattern.length
                            ? (this._.state = 0, 2)
                            : 1;
                    }
                    if (this._.state) {
            ...
            A = function (a) {
                ...
                searchRange: null, matchRange: null, find: function (a, b, d, f, e, E) {
                    ...
                    for (var k = new z(a, !b), l = 0, m = "%"; null !== m;) {
                        ...
                        if (2 == l) {
                            if (d) {
                                ...
                                h = new n(h, !0);
                                p = new n(p, !0);
                                if (!A(h.back().character) || !A(p.next().character)) {
                                    continue
                                }
                            }
                    ...
                    if (!this.matchRange || !this.matchRange.isMatched() || this.matchRange._.isReplaced || this.matchRange.isReadOnly() ||
                        a) {
                        a && this.matchRange &&
                        (this.matchRange.clearMatched(), this.matchRange.removeHighlight(), this.matchRange = null), a =
                            this.find(b, f, e, g, !k);
                    } else {
                        this.matchRange.removeHighlight();
        ...
        return {
            ...
            minWidth: 350, minHeight: 170, buttons: [CKEDITOR.dialog.cancelButton(c, {label: c.lang.common.close})], contents: [{
                ...
                label: f.replace, accessKey: "M", elements: [{
                    ...
                    children: [{
                        ...
                        type: "button", id: "btnFindReplace", align: "left", style: "width:100%", label: f.replace, onClick: function () {
                            var a = this.getDialog();
                            e.replace(a, a.getValueOf("replace", "txtFindReplace"), a.getValueOf("replace", "txtReplace"),
                                a.getValueOf("replace", "txtReplaceCaseChk"), a.getValueOf("replace", "txtReplaceWordChk"),
                    ...
                    children: [{
                        ...
                        onClick: function () {
                            ...
                            for (c.fire("saveSnapshot"); e.replace(a, a.getValueOf("replace",
                                "txtFindReplace"), a.getValueOf("replace", "txtReplace"), a.getValueOf("replace", "txtReplaceCaseChk"),
                                a.getValueOf("replace", "txtReplaceWordChk"), !1, !0);) {
                                ;
                            }
                            e.replaceCounter ? (alert(f.replaceSuccessMsg.replace(/%1/, e.replaceCounter)), c.fire("saveSnapshot")) : alert(
                                f.notFoundMsg)
                        }
                    }]
                }, {
                ...
                this.selectPage = CKEDITOR.tools.override(this.selectPage, function (f) {
                    return function (e) {
                        ...
                        if (c) {
                            ...
                            for (m = 0; m < h; m++) {
                                k = this.getContentElement(B[e], v[m][e]), l =
                                    this.getContentElement(B[g], v[m][g]), l.setValue(k.getValue())
                            }
                        }
                    }
                })
                ...
                var a;
                e.matchRange && e.matchRange.isMatched() &&
                (e.matchRange.removeHighlight(), (a = e.matchRange.toDomRange()) && c.getSelection().selectRanges([a]), c.focus());
                delete e.matchRange
            }, onFocus: function () {
    ...
    var r, y = function () {
        ...
        v = [["txtFindFind", "txtFindReplace"], ["txtFindCaseChk", "txtReplaceCaseChk"], ["txtFindWordChk", "txtReplaceWordChk"],
