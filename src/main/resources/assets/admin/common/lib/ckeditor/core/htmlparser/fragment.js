...
(function () {
    ...
    // parser fixing.
    var nonBreakingBlocks = CKEDITOR.tools.extend({table: 1, ul: 1, ol: 1, dl: 1}, CKEDITOR.dtd.table, CKEDITOR.dtd.ul, CKEDITOR.dtd.ol,
        CKEDITOR.dtd.dl);
    ...
    CKEDITOR.htmlParser.fragment.fromHtml = function (fragmentHtml, parent, fixingBlock) {
        ...
        var root = parent instanceof CKEDITOR.htmlParser.element ? parent : typeof parent == 'string' ? new CKEDITOR.htmlParser.element(
            parent) : new CKEDITOR.htmlParser.fragment();
        ...
        parser.onTagOpen = function (tagName, attributes, selfClosing, optionalClose) {
            ...
            while (1) {
                ...
                var currentDtd = currentName ? ( CKEDITOR.dtd[currentName] ||
                                                 ( currentNode._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span ) ) : rootDtd;
