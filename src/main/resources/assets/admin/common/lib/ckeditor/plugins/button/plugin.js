    ...
    CKEDITOR.ui.button.prototype = {
        ...
        setState: function (state) {
            ...
            if (element) {
                ...
                state == CKEDITOR.TRISTATE_DISABLED ? element.setAttribute('aria-disabled', true) : element.removeAttribute(
                    'aria-disabled');
                ...
                if (!this.hasArrow) {
                    ...
                    var newLabel = state == CKEDITOR.TRISTATE_ON
                        ? this._.editor.lang.button.selectedLabel.replace(/%1/g, this.label)
                        : this.label;
