    ...
    justifyCommand.prototype = {
        ...
        refresh: function (editor, path) {
            ...
            if (isEditable && path.elements.length === 1) {
                ...
                this.setState(getAlignment(firstBlock, this.editor.config.useComputedState) == this.value
