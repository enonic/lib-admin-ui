...
(function () {
                    ...
                    if (range.collapsed) {
                        ...
                        if (matching) {
                            ...
                            if (startBoundary && endBoundary) {
                                ...
                                range.moveToPosition(matching,
                                    startBoundary ? CKEDITOR.POSITION_BEFORE_START : CKEDITOR.POSITION_AFTER_END);
    ...
    CKEDITOR.plugins.add('font', {
        ...
        init: function (editor) {
            ...
            addCombo(editor, 'FontSize', 'size', editor.lang.font.fontSize, config.fontSize_sizes, config.fontSize_defaultLabel,
                config.fontSize_style, 40);
        }
    });
})();
