    ...
    CKEDITOR.on('instanceCreated', function (ev) {
        ...
        editor.on('contentDom', function () {
                        ...
                        html.on('mousedown', function (evt) {
                            ...
                            function onHover(evt) {
                                ...
                                if (textRng) {
                                    ...
                                    textRng.setEndPoint(
                                        startRng.compareEndPoints('StartToStart', rngEnd) < 0 ? 'EndToEnd' : 'StartToStart', rngEnd);
            ...
            // of the editor (https://dev.ckeditor.com/ticket/9851).
                ...
                editable.attachListener(CKEDITOR.env.ie ? editable : doc.getDocumentElement(), 'mouseup', checkSelectionChangeTimeout,
                    editor);
            }
                    ...
                    var range = sel.getRanges()[0],
                        ascendant = range ? range.startContainer.getAscendant(function (parent) {
                            return parent.type == CKEDITOR.NODE_ELEMENT &&
                                   ( parent.getAttribute('contenteditable') == 'false' || parent.getAttribute('contenteditable') ==
                                     'true' );
                        }, true) : null;
                ...
                if (range) {
                    if (!range.collapsed) {
                        ...
                        while (1) {
                            ...
                            if (startOffset ==
                                ( startContainer.getChildCount ? startContainer.getChildCount() : startContainer.getLength() ) &&
        ...
        getSelectedElement: function () {
            ...
            var node = CKEDITOR.tools.tryThese(
                ...
                function () {
                    ...
                    for (var i = 2; i && !( ( enclosed = range.getEnclosedNode() ) && ( enclosed.type == CKEDITOR.NODE_ELEMENT ) &&
                                    styleObjectElements[enclosed.getName()] && ( selected = enclosed ) ); i--) {
            ...
            if (isMSSelection) {
                ...
                if (endNode) {
                    ...
                    isStartMarkerAlone = ( !( next && next.getText && next.getText().match(fillerTextRegex) ) && // already a filler there?
                                           ( inPre || !startNode.hasPrevious() ||
                                             ( startNode.getPrevious().is && startNode.getPrevious().is('br') ) ) );
