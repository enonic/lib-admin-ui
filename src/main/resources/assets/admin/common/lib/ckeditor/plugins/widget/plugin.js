...
(function () {
        ...
        CKEDITOR.tools.extend(this, widgetDef, {
            ...
            _: {
                downcastFn: ( widgetDef.downcast && typeof widgetDef.downcast == 'string' )
                    ? widgetDef.downcasts[widgetDef.downcast]
                    : widgetDef.downcast
            }
        }, true);
    ...
    function createEditableFilter(widgetName, editableName, editableDefinition) {
        ...
        if (!filter) {
            filter =
                editableDefinition.allowedContent ? new CKEDITOR.filter(editableDefinition.allowedContent) : this.editor.filter.clone();
