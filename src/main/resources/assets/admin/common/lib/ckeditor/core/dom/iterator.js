...
(function () {
        ...
        getNextParagraph: function (blockTag) {
            ...
            if (!block) {
                ...
                if (!block && startBlockLimit && !this.enforceRealBlocks && checkLimits[startBlockLimit.getName()] &&
                    ...
                    this._.nextNode =
                        ( block.equals(lastNode) ? null : this._getNextSourceNode(range.getBoundaryNodes().endNode, 1, lastNode) );
                }
            }
    ...
    function startIterator() {
        ...
        range.enlarge(
            this.forceBrBreak && !touchPre || !this.enlargeBr ? CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS : CKEDITOR.ENLARGE_BLOCK_CONTENTS);
