module api.form.inputtype.principal {
    ...
    export class PrincipalSelector
        ...
        private skipPrincipals: api.security.PrincipalKey[];
        ...
        private readConfig(inputConfig: { [element: string]: { [name: string]: string }[]; }): void {
            ...
            this.skipPrincipals = [].concat(skipPrincipalsConfig)
                .map((cfg: any) => {
                    let val: string;
                    if (api.ObjectHelper.iFrameSafeInstanceOf(cfg, PrincipalKey)) {
                        return cfg;
        ...
        private createComboBox(input: api.form.Input): api.ui.security.PrincipalComboBox {
            ...
            let principalLoader = new api.security.PrincipalLoader()
