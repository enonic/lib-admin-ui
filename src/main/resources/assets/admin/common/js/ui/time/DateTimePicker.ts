...
export class DateTimePicker
    ...
    protected initInput(): void {
        this.input = TextInput.middle('', this.formatDateTime());
        this.input.setPlaceholder(this.builder.inputPlaceholder);
        this.wrapperEl.appendChild(this.input);
    }
