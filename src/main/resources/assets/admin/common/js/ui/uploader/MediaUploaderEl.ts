module api.ui.uploader {
    ...
    export class MediaUploaderEl
        extends api.ui.uploader.UploaderEl<api.content.Content> {
        ...
        private uploadRemoteImage(imgSrc: string) {
            ...
            new api.content.resource.LoadImageRequest().setName(name).setUrl(imgSrc).setParent(parent).sendAndParse().then(
                (content: Content) => {
