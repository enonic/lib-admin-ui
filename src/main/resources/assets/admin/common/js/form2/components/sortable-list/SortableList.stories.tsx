    ...
    return (
        <div className='w-96'>
            <p className='mb-3 text-subtle text-xs'>
                ...
                it; its lower half enters the region at the start. Dragging down at the list edge steps out past the
                layout. Rows shift around a faded placeholder while the dragged clone re-indents to show its level. It
                dims when the drop is not allowed.
            </p>
            <SortableList
                items={rows}
                keyExtractor={keyExtractor}
