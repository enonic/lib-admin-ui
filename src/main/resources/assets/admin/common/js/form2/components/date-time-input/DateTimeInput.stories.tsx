    ...
    render: () => (
        <div className='w-96 space-y-6 p-4'>
            ...
            <div>
                ...
                <DateTimeInput {...defaultArgs} value={ValueTypes.LOCAL_DATE_TIME.newValue('2025-06-15T14:30')} />
            </div>
            <div>
            ...
            <div>
                ...
                <DateTimeInput {...defaultArgs} config={makeConfig({default: new Date(2025, 0, 1, 9, 0)})} />
            </div>
            <div>
