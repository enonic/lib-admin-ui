...
export const RequiredEmpty: Story = {
    ...
    render: () => (
        <div className='w-80 p-4'>
            <h3 className='mb-3 font-medium text-sm'>Required (1:3) — no values</h3>
            <ComboBoxInput {...makeDefaultArgs([], 1, 3)} />
        </div>
    ),
};
...
export const MinViolation: Story = {
    ...
    render: () => (
        <div className='w-80 p-4'>
            <h3 className='mb-3 font-medium text-sm'>Min 2 — only 1 selected</h3>
            <ComboBoxInput {...makeDefaultArgs(['no'], 2, 5)} />
        </div>
    ),
};
...
export const WithFieldError: Story = {
    ...
    render: () => (
        <div className='w-80 p-4'>
            <h3 className='mb-3 font-medium text-sm'>Invalid value not in options</h3>
            <ComboBoxInput {...makeDefaultArgs(['no', 'invalid-value'], 0, 5)} />
        </div>
    ),
};
...
export const AllStates: Story = {
    ...
    render: () => (
        <div className='w-80 space-y-6 p-4'>
            ...
            <div>
                <h3 className='mb-3 font-medium text-sm'>Required Empty (1:3) — occurrence error</h3>
                <ComboBoxInput {...makeDefaultArgs([], 1, 3)} />
            </div>
            <div>
                <h3 className='mb-3 font-medium text-sm'>Min Violation (2:5) — 1 selected</h3>
                <ComboBoxInput {...makeDefaultArgs(['no'], 2, 5)} />
            </div>
            <div>
                <h3 className='mb-3 font-medium text-sm'>Field Error — invalid value</h3>
                <ComboBoxInput {...makeDefaultArgs(['no', 'invalid-value'], 0, 5)} />
            </div>
        </div>
    ),
